...
int main()
{
    ...
    while (window.isOpen())
    {
        ...
        if (rectPosition.x == 800 - x_side && rectPosition.y == 00) chColor(rect);
        if (rectPosition.x == 0 && rectPosition.y == 800 - y_side) chColor(rect);
        if (rectPosition.x == 800 - x_side && rectPosition.y == 800 - y_side) chColor(rect);


        //physics       
        if (rectPosition.x < 0 || rectPosition.x > 800 - x_side) xVelocity *= -1;
